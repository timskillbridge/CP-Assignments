...
CREATE TABLE employee (
    ...
    social_security_id BIGINT UNIQUE,
    FOREIGN KEY social_security_id REFERENCES social_security (id)
);
...
CREATE TABLE gaming_engine (
    engine_id BIGINT GENERATED BY DEFAULT AS PRIMARY KEY,
...
CREATE TABLE employee (
    ...
    salary DECIMAL(7,2) NOT NULL CHECK (salary > 31987.19 AND salary < 60000.01),
    social_security_num,
    FOREIGN KEY social_security_num REFERENCES social_security (ssn),
    shift_id,
